...
void randAI::setDistances()
{
    ...
    if(dir == 0) {      //N
        ...
        if( (cols2->at(0)->getCollider()->getTag() == "bike") || (cols2->at(0)->getCollider()->getTag() == "wall") ) {
            NDist = 2;
        } else if ( (cols->at(0)->getCollider()->getTag() == "bike") || (cols->at(0)->getCollider()->getTag() == "wall") ) {
            NDist = 1;
        } else {
            NDist = 0;
        }
        ...
        //Set WDist = S
        if( (cols2->at(2)->getCollider()->getTag() == "bike") || (cols2->at(2)->getCollider()->getTag() == "wall") ) {
            WDist = 2;
        } else if ( (cols->at(2)->getCollider()->getTag() == "bike") || (cols->at(2)->getCollider()->getTag() == "wall") ) {
            WDist = 1;
        } else {
            WDist = 0;
        }
